...
public class MazeGenerator : MonoBehaviour {
    /* 
        // remove and add to readme
        Wall Settings:
        Box Collider 2D: 
        (L/R) Size: X:0.5, Y:1, Z:-0.5
        (U/D) Size X:1, Y:0.5, Z:-0.5
    ...
    */
    ...
    public void setSize(int row, int columns){
        mazeRows = row;
        mazeColumns = columns;
    }
    ...
    public void MakeExit(){
        ...
        endCell = Instantiate(endCellPrefab, new Vector2(newCell.cellObject.transform.position.x, newCell.cellObject.transform.position.y), endCellPrefab.transform.rotation);
    }
